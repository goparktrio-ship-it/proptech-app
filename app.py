...
def run_capital_gains_tax_app():
    ...
    # 🚨 [UI 신규] 앱 최하단에 비과세 핵심 요건 가이드라인 추가!
    with st.expander("🔍 1세대 1주택 & 일시적 2주택 비과세 핵심 요건"):
        st.markdown("""
        **📌 1세대 1주택 비과세 핵심 요건**<br>
        * **보유 요건:** 주택을 취득한 날로부터 **2년 이상 보유**해야 합니다.<br>
        * **거주 요건:** 2017년 8월 3일 이후 **'조정대상지역'에 지정된 상태에서 취득(잔금일 기준)**한 주택은 **2년 이상 거주**가 필수입니다. (비규제지역 취득 시에는 거주요건이 평생 면제됩니다.)<br>
        * **고가주택 기준:** 양도가액 **12억 원** 이하까지는 세금이 전액 면제되며, 12억 원 초과분은 초과 비율만큼만 세금이 부과됩니다.
        <br><br>
        **⏳ 일시적 1세대 2주택 비과세 요건 (갈아타기)**<br>
        새집으로 이사 가기 위해 일시적으로 2주택이 된 경우, 아래 3가지 요건을 모두 갖추면 1주택자와 동일하게 비과세를 적용받습니다.<br>
        * **1년 텀(Term):** 기존 주택을 취득한 날부터 **최소 1년 이상 지난 후**에 신규 주택을 취득해야 합니다.<br>
        * **3년 내 처분:** 신규 주택을 취득한 날로부터 **3년 이내**에 기존 주택을 팔아야 합니다. (현재 세법 개정으로 기존주택 및 신규주택의 규제지역 여부와 무관하게 모두 '3년'으로 기간이 통일되었습니다.)<br>
        * **기존 주택 요건:** 팔려는 기존 주택은 당연히 '1세대 1주택 비과세 요건(2년 보유 및 규제지역 취득 시 2년 거주)'을 충족한 상태여야 합니다.
        """, unsafe_allow_html=True)

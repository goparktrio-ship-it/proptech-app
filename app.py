...
def main():
    ...
    with st.sidebar:
        ...
        <div class="news-box bg-red">
            ...
            양도세 중과 배제 기한 임박! 단, 기한 내 잔금 청산이 어렵더라도 <b>5월 9일까지 '토지거래허가신청서'를 접수</b>한 사람까지는 유예 혜택을 받을 수 있도록 구제책이 확정되었습니다.
        </div>
        <div class="news-box bg-yellow">
            <div class="news-date">⚠️ [2026.04 이슈] 서울·수도권 공시가격 '껑충'</div>
            올해 서울 및 수도권 주요 단지의 공시가격이 <b>큰 폭으로 폭등</b>했습니다. 종부세 등 연간 보유세 부담이 껑충 뛸 것으로 예상되니 '세금 계산' 탭에서 미리 시뮬레이션해 보세요.
        </div>
        <div class="news-box bg-blue">
            <div class="news-date">🏦 [2026.04 금융] 금리 동결 속 '추가 인상' 가능성 대두</div>
            한국은행이 기준금리를 동결했지만, 불안정한 물가 흐름과 환율 변동성으로 인해 <b>향후 금리 인상 가능성이 오히려 높아졌다는 분석</b>이 지배적입니다. 보수적인 자금 계획이 필수입니다.
        </div>
        <div class="news-box bg-gray">
            <div class="news-date">📌 [2026.04.17 시행] 수도권 주담대 조이기</div>
            가계부채 관리방안에 따라 다주택자의 <b>수도권 및 규제지역 내 주담대 만기 연장이 원칙적으로 금지</b>됩니다. 자금 조달 탭에서 변동된 스트레스 DSR 한도를 꼼꼼히 체크하세요.
        </div>
        """, unsafe_allow_html=True)

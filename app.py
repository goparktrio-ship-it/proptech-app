    ...
    with col2:
        ...
        with st.expander("❓ 규제지역 번호별 상세 연혁"):
            ...
            <ul style='margin-top: 0; padding-left: 20px;'>
                ...
                <li><b>③ 과천/광명/하남/성남(분당,수정):</b> 과거 지정 → '23.1 해제 → '25.10 재지정</li>
                <li><b>④ 안양동안/용인수지/의왕/성남중원/수원(영통,장안,팔달):</b> 과거 지정 → '22.11 해제 → '25.10 재지정</li>
                <li><b>⑤ 동탄/구리/안양만안/용인기흥/수원권선 등:</b> 과거 해제 후 현재까지 비규제 유지</li>
...
def main():
    ...
    with st.sidebar:
        ...
        <div class="news-box bg-red">
            <div class="news-date">🚨 [2026.04 속보] 다주택자 양도세 중과 유예 기한 확대 적용</div>
            양도세 중과 배제 기한 임박! <b>5월 9일까지 '토지거래허가신청서'를 접수</b>한 사람까지 유예.
        </div>
        <div class="news-box bg-yellow">
            <div class="news-date">⚠️ [2026.04 이슈] 서울·수도권 공시가격 '껑충'</div>
            서울 및 수도권 주요 단지의 공시가격이 <b>큰 폭으로 폭등</b> 종부세 등 연간 보유세 부담 많이 늘어날 듯 ...'세금 계산' 탭에서 미리 체크.
        </div>
        <div class="news-box bg-blue">
            <div class="news-date">🏦 [2026.04 금융] 금리 동결 속 '추가 인상' 가능성 대두</div>
            한국은행이 기준금리를 동결했지만, <b>향후 금리 인상 가능성 높다는 분석</b>이 지배적. 보수적인 자금 계획이 필수.
        </div>
        <div class="news-box bg-gray">
            <div class="news-date">📌 [2026.04.17 시행] 수도권 주담대 조이기</div>
            가계부채 관리방안에 따라 다주택자의 <b>수도권 및 규제지역 내 주담대 만기 연장이 원칙적으로 금지</b> 자금 조달 탭에서 변동된 스트레스 DSR 한도를 꼼꼼히 체크.
        </div>
        """, unsafe_allow_html=True)
